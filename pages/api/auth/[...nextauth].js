...
import {AuthProviderEnum} from "../../../src/model/AuthProvider";
import {
  findUserByProviderAndOauthId,
  loginUser,
  registerUser
} from "../../../src/api-client/authentication/UserService";
...
export default NextAuth({
  ...
  callbacks: {
    ...
    async jwt({ token, user, account, profile, isNewUser }) {
      console.log('check if refreshed');
